...
# Form implementation generated from reading ui file './uis/new_operator.ui'
#
...
class Ui_NewOperator(object):
    def setupUi(self, NewOperator):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(160, 230, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(20, 20, 421, 192))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.Password1)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.Password2)
        ...
        NewOperator.setTabOrder(self.Organization, self.Phone)
